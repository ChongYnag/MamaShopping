 ...
 */
$(function(){
	$("#main-wait,#main-fa,#main-shou,#main-pin").css("display","none");
...
function css(){
	...
	$("#top>ul").css({"width":Q(720)});
    $("#top>ul>li").css({"font-size":Q(36),"line-height":Q(86),"margin-right":Q(36)});
    ...
    $(".main>div>p>span").css({"font-size":Q(32),"line-height":Q(47),"margin-left":Q(20)});
